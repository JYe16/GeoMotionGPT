...
if TYPE_CHECKING:
    from utils.modeling_utils_modified import PreTrainedModel
...
class GenerationMixin:
    ...
    def generate(
        ...
        negative_prompt_ids: Optional[torch.Tensor] = None,
        negative_prompt_attention_mask: Optional[torch.Tensor] = None,
        input_bvp: Optional[torch.FloatTensor] = None,
        **kwargs,
    ...
    def _sample(
        ...
        synced_gpus: bool,
        streamer: Optional["BaseStreamer"],
        input_bvp: Optional[torch.FloatTensor],
        **model_kwargs,
    ) -> Union[GenerateNonBeamOutput, torch.LongTensor]:
        r"""
        ...
        while self._has_unfinished_sequences(
            ...
            # forward pass to get next token
            outputs = self(**model_inputs, input_bvp=input_bvp, return_dict=True)
